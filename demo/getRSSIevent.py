...
while loop == True: #initate infinite loop every 60 seconds
	...
	overheat = False
	if cpu_temp > 20: # if cpu temp more than 80 deg celsius
	...
	if cpu_usage > 20: # if cpu usage more than 80 percent
		print('CPU Overload ... ')
		overload = True
		response = requests.post("https://vms.inmarsat.com/apiv2", json={"event":"processor overheat","ts": epoch, "severity":1})
	...
	if memory_usage > 20: # if cpu usage more than 80 percent
